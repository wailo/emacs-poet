* po.et API client [[https://travis-ci.com/wailo/emacs-poet][https://travis-ci.com/wailo/emacs-poet.svg?branch=master]] [[https://melpa.org/packages/poet-client-badge.svg]]
